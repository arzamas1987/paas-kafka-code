...
# Directories
mkdir -p pizza_app/models pizza_app/generator pizza_app/services
mkdir -p chapter10 chapter11 chapter12 chapter13 tests var

# Make chapter folders packages
touch chapter10/__init__.py chapter11/__init__.py chapter12/__init__.py chapter13/__init__.py
...
echo "Files recreated. Now activate venv, install requirements, and run: python -m chapter10.dry_run_event_models"
